...
$sections[] = array(
				...
				'fields' => array(
					...
					array(
						...
						'sub_desc' => __('Upload your logo <strong>(Recommended size 151x27px)</strong> using the Upload Button or insert image URL.', 'mythemeshop')
						),
					array(
						'id' => 'mts_favicon',
						'type' => 'upload',
					...
					array(
						...
						'options' => array('a' => __('Author Name','mythemeshop'), 'b' => __('Date','mythemeshop'), 'c' => __('Comment Count','mythemeshop')),
						'std' => array('a' => '1', 'b' => '1', 'c' => '1')
						),
					)
				);
$sections[] = array(
				...
				'fields' => array(
					...
					array(
						...
						'sub_desc' => __('Choose from <strong>6 different layouts</strong> for your site. This will apply on homepage as well as single posts(Sidebar only). <br/><strong>[C]</strong>: Content<br/><strong>[R]</strong>: Random Posts<br/><strong>[S]</strong>: Sidebar.', 'mythemeshop'),
						'options' => array(
										'crslayout' => array('img' => NHP_OPTIONS_URL.'img/layouts/crs.png'),
										'rcslayout' => array('img' => NHP_OPTIONS_URL.'img/layouts/rcs.png'),
										'srclayout' => array('img' => NHP_OPTIONS_URL.'img/layouts/src.png'),
										'scrlayout' => array('img' => NHP_OPTIONS_URL.'img/layouts/scr.png'),
...
$sections[] = array(
				...
				'fields' => array(
					...
					array(
						...
						'type' => 'button_set',
						'title' => __('Show Search Form in Header', 'mythemeshop'), 
						'options' => array('0' => 'Off','1' => 'On'),
						'sub_desc' => __('Use this button to enable <strong>Search form in Header</strong>.', 'mythemeshop'),
						'std' => '0'
						),
					array(
						'id' => 'mts_feedburner',
					...
					array(
						...
						'sub_desc' => __('Enter your Pinterest link here.', 'nhp-opts')
						),
					)
				);	
$sections[] = array(
